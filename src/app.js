      ...
      if (eventArr.length === 0) {
        ...
        return calendar.events.insert(
          ...
          err => {
            ...
            return console.log('Your Power Shout Event is Created Successfully.')
          })
        }
      // If event array is not empty log that we are busy.
      return console.log(`Sorry you have already reached Power Shout limit...`)
    }
  )
